...
def newSM(i):
    ...
    if k > 2:
        stut2 = False
    # if LP == True and buynum*1.0015 < ls_high[i+5]:
    #     stut3 = True
...
def newBM(i):
    ...
    if k > 2:
        stut2 = False
    # if SP == True and sellnum*0.9985 > ls_low[i+5]:
    #     stut3 = True
    result = (stut and stut1 and stut2) or stut3
    return result 
            ...
            if not(actiontime == nownow()):
                ...
                if MTGG == True:
                    ...
                    if SP == True and ls_oclo[-2] < sellnum*0.997:
                        ...
                        mail(text,title)
                        print('possition END')
                if ls_oclo[-2] < ls_bollow[-2]*0.9965 and SP == False and LP == False and MTGG == False and ls_oclo[-3] - ls_oclo[-4] < ls_oclo[-2] -ls_oclo[-3]:
                    LP = True
                    MTGG = True
                    PN = amountgetter()
                    buybit(PN)
                    ...
                    title = 'P-BUY'
                    mail(text,title)
                if ls_ochi[-2] > ls_bolhigh[-2]*1.0035 and LP == False and SP == False and MTGG == False and ls_ochi[-3] - ls_ochi[-4] > ls_ochi[-2] - ls_ochi[-3]:
                    SP = True
                    MTGG = True
                    PN = amountgetter()
                    sellbit(PN)
